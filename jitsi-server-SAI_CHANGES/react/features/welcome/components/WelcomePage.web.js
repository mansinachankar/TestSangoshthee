...
const CONFERENCES_PARTICIPANTS_COUNT_URL =
  "https://tsangoshthee.cdac.in/getdata/";
/**
                    ...
                    <div className = 'welcome-card-row'>
                            ...
                            <div class="counter">
                                <div class="square">
                                    <div class="content">
                                        <div class="count">
                                        {this.state.conferenceDetails.conference
                                        ? this.state.conferenceDetails.conference
                                        : "0"}                                    
                                    </div>
                                ...
                                <div class="square">
                                    <div class="content numbers">
                                        <div class="count">{this.state.conferenceDetails.members
                                        ? this.state.conferenceDetails.members
                                        : "0"}  </div>
                                        <div class="display-text">Current Participants</div>
                                    </div>
                                </div>
                            </div>
                            <div class="count-timestamp">{this.state.conferenceDetails ? 
                            this.state.conferenceDetails.timestamp : 0}</div>
